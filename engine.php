		...
		for ($i=0; $i<$count; $i++)
		{
			...
			if (Database::checkTrackersCredentialsExist($tracker))
			{
				...
				if (file_exists($engineFile))
				{
					...
					if ($tracker == 'rutracker.org' || $tracker == 'nnm-club.me' || $tracker == 'new-rutor.org' || $tracker == 'tfile.me' || $tracker == 'kinozal.tv' || $tracker == 'anidub.com' || $tracker == 'casstudio.tv'  || $tracker == 'animelayer.ru' || $tracker == 'tracker.0day.kiev.ua' || $tracker == 'torrents.net.ua' || $tracker == 'rustorka.com')
					{
