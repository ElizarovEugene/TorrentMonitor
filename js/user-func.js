...
{    // Скользящее меню
    ...
    $("#setting").submit(function()
    {
        ...
        var $form = $(this),
            ...
            sendUpdateProwl = $form.find('input[name="sendUpdateProwl"]').val();
            ...
            sendWarningProwl = $form.find('input[name="sendWarningProwl"]').val();
